...
import com.lv.library_core.base.ui.activity.skin.SkinResource
import com.lv.library_core.base.ui.activity.skin.attr.SkinAttr
import com.lv.library_core.base.ui.activity.skin.attr.SkinView
import com.lv.library_core.base.ui.activity.skin.callback.ISkinChangeListener
import com.lv.library_core.base.ui.activity.skin.support.SkinAppCompatViewInflater
import com.lv.library_core.base.ui.activity.skin.support.SkinAttrSupport
...
abstract class BaseSkinActivity<VM : BaseViewModel> : BaseActivity<VM>(),
    ...
    override fun onCreateView(
        ...
        if (view != null) {
            ...
            Log.e("需要换肤的资源：$name --->", "${skinAttrs.size}")
        }
        return view
    }
